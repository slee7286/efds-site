...
export default function TermsPage() {
  return <InformationPage eyebrow="Terms" title="Terms of use." intro="These practical terms describe the expected use of the EFDS public website and its authenticated member workspace.">
