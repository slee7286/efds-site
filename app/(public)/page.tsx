...
export default async function HomePage() {
  ...
  return <main id="main-content">
    ...
    <section className="sponsor-home container" aria-labelledby="home-sponsors-heading">
      <div className="section-rule"><span>01 / Sponsors</span><span>With EFDS</span></div>
    ...
    <section className="campus-section container" id="society">
      <div className="section-rule"><span>02 / The society</span><span>Made at Imperial</span></div>
    ...
    <section className="society-index container">
      <div className="section-rule"><span>03 / Explore EFDS</span><span>Start here</span></div>
