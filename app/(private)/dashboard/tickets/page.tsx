...
export default async function TicketsPage({ searchParams }: { searchParams?: Promise<Params> }) {
  ...
  const [{ tickets }, profile] = await Promise.all([getTicketWorkspace(), getCurrentProfile()]);
