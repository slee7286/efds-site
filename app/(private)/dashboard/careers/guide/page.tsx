...
export default async function CareerGuidePage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  return <div className="app-content career-guide">
    ...
    {!allowed ? <section className="surface career-guide-access"><h2>Verified EFDS members can read the full guide.</h2><p>Every signed-in member can use the public careers page and Imperial Careers Service. Ask for EFDS membership review to unlock the company research library.</p><Link className="button button-primary" href="/dashboard/profile">Request EFDS review <ArrowUpRight size={15} /></Link></section> : <>
      <div className="career-guide-note"><strong>Research snapshot · 24 September 2026</strong><p>These are reviewed summaries of public employer sources, not a live vacancy board or an endorsement. Roles, eligibility and deadlines can change. Verify current details on each employer’s website before applying.</p></div>
