...
export default async function SignupPage() {
  ...
  return <main className="auth-page" id="main-content"><section className="auth-aside"><Brand /><div><div className="eyebrow">Join the workspace</div><h1>Make your<br /><em>account.</em></h1><p>Explore events and the tools open to everyone with an EFDS account.</p><DisciplineGraphic type="data" /></div><Link className="button button-quiet" style={{ color: "#c2cada" }} href="/"><ArrowLeft size={15} />Back to the society</Link></section><section className="auth-panel"><div className="auth-box"><div className="eyebrow">Create account</div><h2>Start as an EFDS member.</h2><p>Enter your Imperial email and open the secure link we send you. After confirming your email, you can set a password and enter the dashboard immediately. EFDS student access is reserved for verified students on Imperial’s BSc Economics, Finance and Data Science; Union society membership alone does not grant it. Committee roles are granted separately.</p><LoginForm initialAction="setup" googleEnabled={googleEnabled} /><p className="auth-footnote"><LockKeyhole size={12} /> Already have an account? <Link href="/login">Sign in</Link>.</p></div></section></main>;
}
